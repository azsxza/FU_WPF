...
namespace FU_UWP
{
    class ValueToProcessConverter : IValueConverter
    {
        ...
        private const int SuccessRateFontSize = 94;
        ...
        static ValueToProcessConverter()
        {
            ...
            SuccessRateTypeface = new Typeface(new FontFamily("FZZhongQian-M16S"), new FontStyle(), new FontWeight(), new FontStretch());
        }
        ...
        private Geometry GetGeometry(double value, double maxValue, double radiusX, double radiusY, double thickness, double padding)
        {
            ...
            percentString = string.Format("{0}", 5 - Math.Round(percent * 5));
